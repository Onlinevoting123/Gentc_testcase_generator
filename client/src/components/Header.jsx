...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>welcome to Testcase generator application</h2>
      <p className='mb-8 max-w-md'>let's start sign up and verify your email</p>
      <button onClick={()=>navigate('/e')}  className='border border-gray-500 rounded-full px-8 py-2.5 hover:bg-gray-100 transition-all'>Get started</button>
    </div>
  )
}
